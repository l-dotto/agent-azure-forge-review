...
Executes the Forge code review agent using configurable LLM providers
and outputs structured findings in JSON format.

Supported LLM Providers:
- Anthropic Claude Opus 4.5 (default - deeper analysis)
- OpenAI GPT-4
- Azure OpenAI
- Google Gemini
"""
...
class CodeReviewRunner:
    ...
    # Default models per provider - Using Opus for deeper analysis
    DEFAULT_MODELS = {
    ...
    def _load_agent_prompt(self) -> str:
        """Load the code review agent prompt template"""
        prompt_path = Path(__file__).parent.parent.parent / '.claude' / 'agents' / 'pragmatic-code-review-subagent.md'
    ...
    def run(self) -> Dict[str, Any]:
        ...
        """
        console.print("\n[bold blue]🔨 Forge - Code Review Agent[/bold blue]")
        ...
        with Progress(
            ...
            task2 = progress.add_task("[cyan]Preparing code review prompt...", total=None)
            ...
            # Step 3: Call LLM API
            task3 = progress.add_task("[cyan]Analyzing code quality and architecture...", total=None)
            ...
            findings = parse_agent_output(response_markdown, agent_type='code')
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Run code review agent on pull request changes',
